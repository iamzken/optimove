...
(function () {
	...
	a.prototype.getOffset = function () {
	...
	}, c.object.extend(a.prototype, {_closeOtherSearchInfo:function () {
		...
		if (!this.localSearch) {
			this.localSearch = new BMap.LocalSearch(g, {renderOptions:e, onSearchComplete:function (h) {
				f._clearAddress();
				f._drawCircleBound();
			}});
		}
		if (!this.transitRoute) {
			this.transitRoute = new BMap.TransitRoute(g, {renderOptions:e, onSearchComplete:function (h) {
				f._transitRouteComplete(f.transitRoute, h);
			}});
		}
		if (!this.drivingRoute) {
			this.drivingRoute = new BMap.DrivingRoute(g, {renderOptions:e, onSearchComplete:function (h) {
