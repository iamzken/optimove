...
'<html>'+
	'<head>'+
		...
		'<style type="text/css">'+
			...
			'}'+
		'</style>'+
		'<script type="text/javascript" src="http://192.169.10.81:8088/optimove/api/baidu_map_api_core.js"></script>'+
		'<script type="text/javascript" src="http://192.169.10.81:8088/optimove/api/baidu_map_api_drawing_manager.js"></script>'+
		'<link rel="stylesheet" href="http://192.169.10.81:8088/optimove/api/DrawingManager_min.css" />'+
		'<script type="text/javascript" src="http://192.169.10.81:8088/optimove/api/SearchInfoWindow_min.js"></script>'+
		'<link rel="stylesheet" href="http://192.169.10.81:8088/optimove/api/SearchInfoWindow_min.css" />'+
		'<title></title>'+
	'</head>'+
	'<body>'+
		'<div id="allmap"></div>'+
	...
	'<script type="text/javascript" charset="GB2312">'+
		'var uploadImgDir = "http://192.169.10.81:8088/optimove/mobileimages/";'+
	...
	'</script>'+
'</html>'
var subSearchUrlForDataList = "/optimove/modelattributes/searchModelAttributeAndDataList.do";
var searchModelattribute4Display = "/optimove/modelattributes/searchModelattribute4Display.do";
function getBaiduMap(tabName,queryParams) {
	...
	var rows;
	$.ajax({
		url : searchModelattribute4Display,
		async :false,
		data : {
			tablename : tabName
		},
	...
	return baiduMapHtml.replace(oldPoints,newPoints);
}