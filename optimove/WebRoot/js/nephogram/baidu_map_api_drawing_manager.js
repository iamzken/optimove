...
(function () {
	...
	(function () {
		...
		if (/msie (\d+\.\d)/i.test(navigator.userAgent)) {
			b.browser.ie = b.ie = document.documentMode || +RegExp["$1"];
		}
	})();
	...
	d.prototype._getRectanglePoint = function (h, g) {
	    var aa;
	    try{
	    	aa = [new BMap.Point(h.lng, h.lat), new BMap.Point(g.lng, h.lat), new BMap.Point(g.lng, g.lat), new BMap.Point(h.lng, g.lat)];
	    }catch(e){
	    	aa = [new BMap.Point(121.548392, 29.816413), new BMap.Point(121.548392, 29.816413), new BMap.Point(121.548392, 29.816413), new BMap.Point(121.548392, 29.816413)];;
	    }
		return aa;
	};
