...
<body class="easyui-layout">
	<div class="wrapper1 wrapper-content1 panel-fit gray-bg">
		<div id='dataList'>
			<div id="tb"
				...
				<div id="searchdiv">
					<form id='searchForm' action="" method="post">
						名称: <input type="text" id="apiname" name="apiname" class="form-text"/>
						版本号: <input type="text" id="apiversion" name="apiversion" class="form-text"/> <input
			...
			<form id='addForm' action="" method="post">
				<table>
					...
					<tr>
						...
						<td>
						<select class="form-text" id="providerid" name="providerid" style="width: 180px" constantId="tblProviderMag"></select>
					</tr>
				</table>
			</form>
		</div>
