...
ajaxConstants("tblMapModelMag|mapModelId|mapModelName|attributedes|orderBy=mapModelId");
		...
		<script type="text/javascript">
var searchUrl = "<%=request.getContextPath()%>/mapmodelmags/getMapModelJson.do?modeltype=2";
var getMapModelTreeUrl = "<%=request.getContextPath()%>/mapmodelmags/getMapModelTree.do?modeltype=2";
var getMapModelUrl = "<%=request.getContextPath()%>/mapmodelmags/getMapmodelmagMap.do?modeltype=2";
var treeData = "";
var bdTreeData = "";
var replacestr="";
$(function() {
...
function bdCreateHtmlJs() {
	...
	if(replacestr==""){
		replacestr = "function newMapPoint(){return new BMap.Point(121.533694,29.877552);}";
	}
